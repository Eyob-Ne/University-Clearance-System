  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="relative py-24 bg-gradient-to-br from-indigo-900 via-blue-900 to-indigo-900 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-500 rounded-full mix-blend-overlay opacity-20 blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-500 rounded-full mix-blend-overlay opacity-20 blur-3xl"></div>
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            ...
            className="group relative inline-flex items-center justify-center gap-3 bg-white text-indigo-900 px-10 py-5 rounded-full font-bold text-lg md:text-xl transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.5)]"
          >
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            {/* Card 1 */}
            <div className="group p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="text-white text-xl font-bold mb-3">Paperless Process</div>
            ...
            <div className="group p-8 bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="text-blue-200/80 leading-relaxed">
                Efficient processing that saves time for both students and staff.
              </div>
            </div>
