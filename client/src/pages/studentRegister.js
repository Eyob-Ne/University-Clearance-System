                  ...
                  <div className="mb-6">
                    <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-50 to-emerald-50 rounded-full border border-blue-200/50 shadow-sm">
                      ...
                      <span className="text-sm font-medium text-blue-800">
                        Verified successfully! Complete your account setup
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-gray-500">Required for password reset</span>
                    </div>
                    <div className="relative group">
                      <div className="absolute left-4 top-1/2 transform -translate-y-1/2 z-10">
                        <div className="p-2 bg-gradient-to-br from-purple-100 to-purple-50 rounded-lg group-focus-within:from-purple-200 group-focus-within:to-purple-100 transition-all duration-300">
                          <Mail className="text-purple-600 group-focus-within:text-purple-700 transition-colors" size={18} />
                        </div>
                      </div>
                      <input
                        type="email"
                        ...
                        className="w-full pl-14 pr-12 py-3.5 bg-white/90 border-2 border-gray-200 rounded-xl focus:border-purple-500 focus:ring-4 focus:ring-purple-100/50 outline-none text-gray-800 placeholder-gray-400 transition-all duration-300 shadow-sm hover:shadow-md"
                      />
                      {email && (
                    ...
                    {email && !validateEmail(email) && (
                      <div className="mt-3 flex items-center gap-2 px-4 py-2.5 bg-amber-50/50 border border-amber-200 rounded-lg">
                        <AlertCircle className="text-amber-500" size={16} />
                        <span className="text-amber-700 text-sm">Please enter a valid email address</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <button
                      ...
                      disabled={loading || !validateEmail(email) || password !== confirmPassword || password.length < 6}
